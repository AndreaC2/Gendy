...
<html>
    ...
    <section id="principal">
            <div class="barralateral">
                ...
                <div class="abajo">
                    <form action="">
                        <input class="Flogo" type="image" src="css/Imagenes/f_logo.png" name='Flogo' onclick="" />
                    </form>
                    <form action="">
                        <input class="Ilogo" type="image" src="css/Imagenes/I_logo.png" name='Ilogo' onclick="" />
                    </form>
                    <form action="">
                        <input class="Tlogo" type="image" src="css/Imagenes/T_logo.png" name='Tlogo' onclick="" />
                    </form>
